...
impl<'s> Elaborator<'s> {
    pub(crate) fn new(sink: &'s dyn LogSink) -> Self {
        Self {
            ...
            scoped_gather_fed: std::collections::BTreeSet::new(),
            ...
            ca_zero_scope: std::collections::BTreeSet::new(),
            ...
            clocking_hold_names: std::collections::BTreeMap::new(),
            ...
            array_const_meta: BTreeMap::new(),
            pkg_array_const_vals: BTreeMap::new(),
            pkg_array_const_meta: BTreeMap::new(),
            ...
            rtn_decl_scope: BTreeMap::new(),
            rtn_decl_genvars: BTreeMap::new(),
            gen_genvars: Vec::new(),
            cur_rtn_pkg: Vec::new(),
            ...
            cur_discard: None,
            in_frame_body: false,
            frame_body_auto: false,
            frame_static_guard: BTreeMap::new(),
            frame_hoisted_decls: BTreeSet::new(),
            frame_nonhoistable: BTreeSet::new(),
