...
///
/// This is a SHAPE test only. `Elaborator::override_bits` pairs it with "no fill" and
/// "self-determined width past 64 bits", so an operator top at or below 64 bits never
/// binds through the wide fold.
