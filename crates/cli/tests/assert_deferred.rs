...
fn deferred_recycle_keeps_all_reports() {
    ...
    // ⚠️ The needle is the whole rendered report, not the message text: the
    // message here is the single letter `R`, and counting THAT counted every `R`
