...
| Tests | `cargo nextest run --workspace --locked` runs 8411 tests, all passing, with 15 skipped (they are `#[ignore]`d performance probes, not gates), in about 41 s. CI runs `cargo test --workspace --locked` |
