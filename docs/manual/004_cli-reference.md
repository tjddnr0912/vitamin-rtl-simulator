...
| `format_version` | int | the artifact format this build emits, `32` |
...
| stamp | what it means |
|---|---|
| **`format_version`** | the on-disk container layout, including everything in the out-of-band trailers that the schema hash cannot see. The value in this build is `32` |
