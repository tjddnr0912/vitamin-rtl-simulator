...
> Order after §4.5.416: the preprocessor rung (`define default arguments, prim_assert — ibex_cs_registers
> with PMP now elaborates behind a default-arg-free stub) → header-parameter member widths (lockstep).
>
