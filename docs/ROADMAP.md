...
> names a header parameter (`typedef logic [W-1:0] t;` → E3010 `top.t` — a §4.5.431-family shape),
...
> by every module — loud), `parameter type T` (🆕 L ⓥ, a separate axis), a class body reading a unit
