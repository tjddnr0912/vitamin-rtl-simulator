...
>
> **기준선(2026-07-25)**: format_version **23** · **4473 tests green** · 3-OS CI green · MsgCode **59** · **MSRV 1.85**. 최신 = **§4.5.221**(real-valued parameters — 미해결 3건으로 브랜치 `feat-real-params` 보류·§2 참조). **완료 슬라이스 55건의 상세·§번호별 원문 = [ROADMAP_ARCHIVE.md](ROADMAP_ARCHIVE.md)**(최신이 위) — 이 문서는 전방 전용이므로 완료 서사를 두지 않는다.
>
