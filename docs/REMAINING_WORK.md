...
>
> - **기준(2026-07-19)**: format_version **22** · **3629 tests green** · 3-OS CI green · MsgCode 58 · **MSRV 1.85** · 최신 완료 §4.5.156(loud-reject packed range/dim on a non-vector type — correct-or-loud·parse_net_var 경로). 미착수 DEEP=size-cast `N'(expr)` context width 미전파(ROADMAP §2).
