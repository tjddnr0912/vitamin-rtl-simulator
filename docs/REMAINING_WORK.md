...
>
> - **기준(2026-09-04)**: format_version **29** · **6,527 tests green** · 워크로드 코퍼스 **10/10** · CI **3-OS + `build-no-oracle`** green · MsgCode **68** · **MSRV 1.85** · **기본 백엔드 = `native`**.
...
| **2a** | ⭐ **워크로드 코퍼스 확장** — 지금 **10 중 10 이 돈다**(거절 0 · 1 ruled-split). ⇒ 값을 더 뽑으려면 **행을 늘려야** 한다. **ibex** 가 열리면 코퍼스 첫 SystemVerilog 워크로드 — ⚠️ §4.5.410 실측: 파스 규칙 하나가 아니라 **블로커 넷**이 더 있다(ROADMAP §3 ⑤ ⓐ~ⓓ · §4.5.411 이 ⓑ 와 ⓒ 의 패키지 절반을 닫아 ibex_pkg.sv 는 한 줄(742) 남았다) | `corpus-runner list` · [study/03](study/03-workload-corpus.md) |
