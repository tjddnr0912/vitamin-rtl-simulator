...
> **리뉴얼: 2026-07-02** (사용자 지시 재계획) · 기준 갱신 2026-07-03 = **format_version 19 · 2952 tests green · 3-OS CI green · MsgCode 58** · known **silent-wrong = §C 잔여(㊂ md-packed frame-local·string LOCAL/FRAME-literal follow-on — deep·전용 슬라이스)**, 나머지 잔여는 honest-loud=안전. 최신 = **2026-07-03 string-formal 관계비교 packed 오답 ✅**(§4.5.81·`formal_str` declared-type detection·INLINE+literal/FRAME+var 수정·적대 R1 CLEAN) · ㊁ INLINE widening context-width(§4.5.80·frame-routing·4-round) · EXT2-F gen-for step(§4.5.79) · ㊀ narrow-actual INLINE 인자(§4.5.78) · EXT2-C/E/A/0(§4.5.77/76/75/74). **G2 OBS 트랙**: OBS-1a ✅ · OBS-1b는 EXT2 체인 다음.
