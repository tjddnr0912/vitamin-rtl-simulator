...
> **리뉴얼: 2026-07-02** (사용자 지시 재계획) · 기준 갱신 2026-07-03 = **format_version 19 · 2964 tests green · 3-OS CI green · MsgCode 58** · known **silent-wrong = §C 잔여(INLINE task/func·class-method packed-local·string LOCAL·FRAME-literal — 전부 별개 경로·전용 슬라이스)**, 나머지 잔여는 honest-loud=안전. 최신 = **2026-07-03 ㊂ frame-local md-packed element-select 오답 ✅**(§4.5.82·full width+packed_dims+dim_desc·3 site: frame func/task/block-local·적대 R2 CLEAN) · string-formal 관계비교(§4.5.81) · ㊁ INLINE widening context-width(§4.5.80·4-round) · ㊀ narrow-actual INLINE 인자(§4.5.78) · EXT2-F/C/E/A/0(§4.5.79/77/76/75/74). **G2 OBS 트랙**: OBS-1a ✅ · OBS-1b는 EXT2 체인 다음.
