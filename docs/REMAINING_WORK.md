...
>
> - **기준(2026-09-01)**: format_version **29** · **6,409 tests green** · 워크로드 코퍼스 **9/10** · CI **3-OS + `build-no-oracle`** green · MsgCode **68** · **MSRV 1.85** · **기본 백엔드 = `native`**.
...
| **2** | **§3 loud→supported** — ⭐⭐ 착수 순서는 **워크로드 코퍼스**가 정한다(§4.5.369). 남은 거절 하나 = **⑧ verilog-ethernet**(frame-call subset 밖) · ⚠️ **verilog-axi 는 `Expect::Split`**(돈다 · 다이제스트는 오라클과 다르고 그 잔여는 **오라클 자기모순** = §2-N 판정)이라 제2 오라클 없이 착수 금지 | 2-오라클 · hand-IEEE |
