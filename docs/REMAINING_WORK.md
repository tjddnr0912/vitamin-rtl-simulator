...
>
> - **기준(2026-09-04)**: format_version **29** · **6,898 tests green** · 워크로드 코퍼스 **10/10** · CI **3-OS + `build-no-oracle`** green · MsgCode **68** · **MSRV 1.85** · **기본 백엔드 = `native`**.
