...
>
> - **기준(2026-07-19)**: format_version **22** · **3630 tests green** · 3-OS CI green · MsgCode 58 · **MSRV 1.85** · 최신 완료 §4.5.157(atom+packed-dims loud-reject 全 decl-site 완결 — §3 全 경로). 미착수 DEEP=size-cast `N'(expr)` context width 미전파(ROADMAP §2).
