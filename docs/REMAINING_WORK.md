...
>
> - **기준(2026-07-19)**: format_version **22** · **3617 tests green** · 3-OS CI green · MsgCode 58 · **MSRV 1.85** · 최신 완료 §4.5.154(enum built-in base kind preservation — width + 2-state-ness 전 kind 정확화, silent-wrong 2 수정).
