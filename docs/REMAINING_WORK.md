...
>
> - **기준(2026-07-19)**: format_version **22** · **3626 tests green** · 3-OS CI green · MsgCode 58 · **MSRV 1.85** · 최신 완료 §4.5.155(`$bits` of fixed-width atom array element — prescan atom-width 미러, silent-wrong 1 + const-scalar 보너스). 신규 DEEP 등재=size-cast `N'(expr)` context width 미전파(ROADMAP §2).
