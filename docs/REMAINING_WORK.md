...
> **리뉴얼: 2026-07-02** (사용자 지시 재계획) · 기준 갱신 2026-07-03 = **format_version 19 · 2977 tests green · 3-OS CI green · MsgCode 58** · known **silent-wrong = §C 잔여(INLINE func/task md-packed subst-bound local·FRAME-literal·class 2-state coercion·string local `s[i]`/sibling-block — 전부 별개 경로/축·전용 슬라이스)**, 나머지 잔여는 honest-loud=안전. 최신 = **2026-07-03 string LOCAL 관계비교 오답 ✅**(§4.5.84·inline subst-bound resize 손상=handle-guard+formal_str·적대 R1 CLEAN) · class-method md-packed(§4.5.83) · ㊂ frame-local md-packed(§4.5.82·3 site) · string-formal 관계비교(§4.5.81) · ㊁ INLINE widening context-width(§4.5.80·4-round). **G2 OBS 트랙**: OBS-1a ✅ · OBS-1b는 EXT2 체인 다음.
