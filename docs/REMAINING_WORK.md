...
>
> - **기준(2026-07-19)**: format_version **22** · **3653 tests green** · 3-OS CI green · MsgCode 58 · **MSRV 1.85** · 최신 완료 §4.5.160(body param/localparam comma-list `localparam A=1, B=2;` loud→supported — pending-queue drain·module/iface/program/package/generate 全 body·parser-only·format 불변). 미착수 후보=untyped param 값-결정 타입(§2·sign+width multipart·oracle 有) · size-cast `N'(expr)` context width(§2 DEEP).
