...
| 2 | **§0 T1 잔여 4종** — queue-of-string · multi-dim string · hier · frame-local. **§4.5.222 실측: 한 가족이 아니라 근인 4갈래**(6·7은 dyn 배열에서도 동일 loud)이라 각각 전용 슬라이스 | iverilog ✓ |
...
| 분류 | 항목 수 | 내용 | 정본 |
|---|---:|---|---|
| correct-support 승격 큐 | 13 | T1 잔여 4(근인 4갈래) · T2 독립 4 · T3 전제조건 2 · 정정(stale) 3 | ROADMAP §0 |
