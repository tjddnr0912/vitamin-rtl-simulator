...
> **리뉴얼: 2026-07-02** (사용자 지시 재계획) · 기준 갱신 2026-07-03 = **format_version 19 · 2946 tests green · 3-OS CI green · MsgCode 58** · known **silent-wrong = §C 잔여(string 함수 formal·㊂ md-packed frame-local — INLINE/frame 경로 deep·다음 우선순위 ①=전용 슬라이스)**, 나머지 잔여는 honest-loud=안전. 최신 = **2026-07-03 ㊁ INLINE static-fn widening context-width ✅**(§4.5.80·frame-routing·IEEE §11.6 per-node CW 모델·always_comb 감도 수정·적대 4-round CLEAN) · EXT2-F gen-for step(§4.5.79) · ㊀ narrow-actual INLINE 인자(§4.5.78) · EXT2-C tf-port(§4.5.77) · EXT2-E/A/0(§4.5.76/75/74) · 외부 리포트 2차 EXT2 체인(§A′·ROADMAP §6-2). **G2 OBS 트랙**: OBS-1a ✅ · OBS-1b는 EXT2 체인 다음.
